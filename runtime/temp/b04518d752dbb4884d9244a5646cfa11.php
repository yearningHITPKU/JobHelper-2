<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"/home/xww/workspace/shixineitui/public/../application/front/view/thought/detail.html";i:1527016374;s:71:"/home/xww/workspace/shixineitui/application/front/view/public/base.html";i:1527016374;s:77:"/home/xww/workspace/shixineitui/application/front/view/public/navigation.html";i:1527016374;s:73:"/home/xww/workspace/shixineitui/application/front/view/public/footer.html";i:1527016374;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<form class="form-horizontal bv-form" role="form" id="studentForm" novalidate="novalidate" enctype="multipart/form-data" method="post" action="<?php echo url('create'); ?>" onsubmit="return checkForm();">
    <fieldset id="fieldset">
        <div class="form-group">
            <div class="littleTitle lineFeed littleicon2 col-sm-12"><?php echo $details['owner_name']; ?>发布的<?php if($thought_type==0): ?>面试心得<?php else: ?>面试指导<?php endif; ?></div>
        </div>
        <div class="col-sm-12">
            <div class="articleContainer">
                ...
                <div class="articleContext">
                    ...
                    <div class="job-detail"><p class="text-justify"><?php echo $details['detail']; ?></p></div>
                    <div hidden="hidden"><a style="color: #1D80DD" href="<?php echo url('front/intern/download', ['id'=>$details['id']]); ?>">附件</a></div>
                </div>
                <div class="articleContext">
...
<script>
    ...
    function change_collect(obj, id) {
        ...
        if($icon.attr('class') == 'fa fa-bookmark-o') {
