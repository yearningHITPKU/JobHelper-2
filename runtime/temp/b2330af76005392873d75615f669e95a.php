<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"/home/xww/workspace/shixineitui/public/../application/front/view/index/notice.html";i:1527577422;s:71:"/home/xww/workspace/shixineitui/application/front/view/public/base.html";i:1527016374;s:77:"/home/xww/workspace/shixineitui/application/front/view/public/navigation.html";i:1527016374;s:73:"/home/xww/workspace/shixineitui/application/front/view/public/footer.html";i:1527016374;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="form-group">
    <div class="littleTitle lineFeed littleicon2 col-sm-12">通知公告</div>
</div>
<div class="intern-list">
    <table class="table table-bordered">
        <tbody>
        <?php if(is_array($interns) || $interns instanceof \think\Collection || $interns instanceof \think\Paginator): if( count($interns)==0 ) : echo "" ;else: foreach($interns as $key=>$vo): ?>
        <tr>
            ...
            <td style="width: 20%; text-align: center">
                <?php echo date("m-d",strtotime($vo['time_publish'])); ?>
            </td>
        </tr>
