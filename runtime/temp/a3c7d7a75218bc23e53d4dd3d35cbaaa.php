<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"/home/xww/workspace/shixineitui/public/../application/user/view/interns/interns.html";i:1527845322;s:70:"/home/xww/workspace/shixineitui/application/user/view/public/base.html";i:1527016374;s:76:"/home/xww/workspace/shixineitui/application/user/view/public/navigation.html";i:1528099986;s:72:"/home/xww/workspace/shixineitui/application/user/view/public/footer.html";i:1527016374;}*/ ?>
<!--
...
<div class="littleTitle lineFeed littleicon2 col-sm-12"><i class="fa fa-hand-o-right"></i>内推信息</div>
<div style="padding-left: 5%; padding-right: 5%">
    <form class="form-horizontal bv-form" role="form" id="studentForm" novalidate="novalidate"
        ...
        <fieldset id="fieldset">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <span class="twitter-typeahead" style="position: relative; display: block;">
                            ...
                            <input id="title" class="form-control tt-input" placeholder="请输入完整的内推标题" name="title"
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label">
                    <span class="star">*</span>工作地点：</label>
                <div class="col-sm-8">
                    <input class="form-control" type="text" placeholder="请填写工作地点" value="" name="location">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">
                ...
                <div class="col-sm-8">
                    <input class="form-control" type="text" placeholder="请填写企业名称" value="" name="corp_name">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input class="form-control" type="text" placeholder="请填写工作职位" value="" name="position">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-3"><span class="star">*</span>应聘条件：</label>
                <div class="col-sm-8">
                    <select class="form-control" name="grade">
                        <option value="0">应届</option>
                        <option value="1">往届</option>
                        <option value="2">应届&往届</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-3"><span class="star">*</span>工作性质：</label>
                <div class="col-sm-8">
                    <select class="form-control" name="type">
                        <option value="0">实习</option>
                        <option value="1">就业</option>
                        <option value="2">就业&实习</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="control-label col-sm-3">
                    <span class="star">*</span>详细内容：
                </label>
                <div class="col-sm-8">
                    <textarea name="detail" class="form-control" rows="19" maxlength="1000" placeholder="请填写详细内容"
        ...
        <div class="add-more" id="saveAndSubmit">
            ...
            <button type="submit" id="btn_submitInfo" class="btn btn-success">
...
<script type="text/javascript">
    ...
    $("#btn_submitInfo").click(function (event) {
        ...
        if (bv.isValid()) {
            ...
            $.post("<?php echo url('user/interns/create'); ?>", formData,
                function (data) {
                    document.getElementById('btn_submitInfo').innerHTML = "提交";
                    alert(data.message);
                    window.location.href = "<?php echo url('user/interns/index_myinterns'); ?>";
                },
