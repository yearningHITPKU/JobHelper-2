...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td class="td-manage">
                <!--<a title="编辑" href="javascript:;" onclick="user_edit('编辑','/admin/user/user_edit','','400','300')" class="ml-5" style="text-decoration:none">
                    <i class="layui-icon">&#xe642;</i>
                </a>-->
                <a title="编辑" href="javascript:;" onclick="user_edit(this,<?php echo $vo['id']; ?>,<?php echo $vo['uid']; ?>,<?php echo $vo['name']; ?>)" class="ml-5" style="text-decoration:none">
                    <i class="layui-icon">&#xe642;</i>
                </a>
...
<script>
    ...
    function user_edit (obj,id,uid,name){
        layer.msg('可以跳到前台具体问题页面',{icon:1,time:1000});
        console.log('55555555555555555555555');
        $.ajax({
            type: 'POST',
            url: "<?php echo url('User/user_edit'); ?>",
            data: {'id':id, 'uid':uid, 'name':name},
            dataType: "json",
        })
    }
